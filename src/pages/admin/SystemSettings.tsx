...
const SystemSettings = () => {
  ...
  // Add state for new department dialog
  ...
  // Add handler for adding a new department
  const handleAddDepartment = () => {
    ...
    setTimeout(() => {
      const newDepartment = {
        id: `dept${deptList.length + 1}`,
        name: newDepartmentName,
        active: true
      };
      
      setDeptList([...deptList, newDepartment]);
          ...
          <TabsContent value="departments">
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-2">
                ...
                <Button size="sm" onClick={() => setNewDepartmentDialog(true)}>
                  Add Department
                </Button>
              </CardHeader>
              <CardContent>
      ...
      <Dialog open={newDepartmentDialog} onOpenChange={setNewDepartmentDialog}>
        <DialogContent className="sm:max-w-[425px]">
          ...
          <DialogFooter>
            ...
            <Button onClick={handleAddDepartment} disabled={loading || !newDepartmentName.trim()}>
              {loading ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : null}
              Add Department
            </Button>
          </DialogFooter>
